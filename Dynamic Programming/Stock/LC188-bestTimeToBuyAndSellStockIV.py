...
class Solution:
    def maxProfit(self, k: int, prices: List[int]) -> int:
        n = len(prices)
        dp = [[[-1 for z in range(k+1)] for y in range(2)] for x in range(n)]
...
class Solution:
    def maxProfit(self, k: int, prices: List[int]) -> int:
        n = len(prices)
        dp = [[[0 for z in range(k+1)] for y in range(2)] for x in range(n + 1)]
...
class Solution:
    def maxProfit(self, k: int, prices: List[int]) -> int:
        n = len(prices)
        after = [[0 for col in range(k+1)] for row in range(2)]
        cur = [[0 for col in range(k+1)] for row in range(2)]
